    ...
    <FunnelShell>
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-4xl px-6 py-20 lg:py-40 text-center">
            <p className="text-xs uppercase tracking-[0.4em] text-[#40c9c6]">Audience Planning</p>
            ...
            <p className="mt-6 text-base md:text-lg text-[#b7c3df] max-w-2xl mx-auto">
              Stop guessing and focus your budget where it matters. Use your leads, contacts, and site visitors to build better audience groups for your campaigns.
            </p>
            <div className="mt-8">
