    ...
    <FunnelShell>
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-4xl px-6 py-20 lg:py-40 text-center">
            <p className="text-xs uppercase tracking-[0.4em] text-[#40c9c6]">Audience Growth</p>
            ...
            <p className="mt-6 text-base md:text-lg text-[#b7c3df] max-w-2xl mx-auto">
              Use your current leads and contacts to find more people with similar buyer profiles, so your ad spend reaches the right audience.
            </p>
            <div className="mt-8">
