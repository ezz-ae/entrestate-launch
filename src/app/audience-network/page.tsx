      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-4xl px-6 py-20 lg:py-40 text-center">
            ...
            <p className="mt-6 text-base md:text-lg text-[#b7c3df] max-w-2xl mx-auto">
              Our system analyzes your existing 'leads' and 'contacts' to identify the characteristics of your best customers. We then use this data to create a powerful lookalike audience, enabling you to target your ad campaigns with precision and get a better ROI.
            </p>
            <div className="mt-8">
                <Link href="/dashboard/meta-audience">
...
export default AudienceNetworkPage;