      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-2xl px-6 py-12 lg:py-20">
            <div className="text-center mb-12">
              <h1 className="text-3xl font-bold text-white mb-4">Property Assistant</h1>
              <p className="text-zinc-400">Answer buyer questions using your live UAE inventory in clear, simple language.</p>
            </div>
            <ChatDemoCard
              title="Project Expert Preview"
