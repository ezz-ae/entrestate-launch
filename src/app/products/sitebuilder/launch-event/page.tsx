    ...
    <FunnelShell>
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-4xl px-6 py-20 lg:py-40 text-center">
            <p className="text-xs uppercase tracking-[0.4em] text-[#7aa5ff]">Event Page Builder</p>
            <h1 className="mt-4 text-4xl md:text-5xl lg:text-6xl font-[var(--font-display)] leading-[1.05]">
                Build Excitement for Your Launch Event
            </h1>
            <p className="mt-6 text-base md:text-lg text-[#b7c3df] max-w-2xl mx-auto">
              Create a dedicated site for your launch event or roadshow. Pull project details from your listings and capture RSVPs directly into your lead list.
            </p>
            <div className="mt-8">
