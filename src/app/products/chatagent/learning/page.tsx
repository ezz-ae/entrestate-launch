    ...
    <FunnelShell>
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-4xl px-6 py-20 lg:py-40 text-center">
            <p className="text-xs uppercase tracking-[0.4em] text-[#ff9ad5]">Property Assistant</p>
            ...
            <p className="mt-6 text-base md:text-lg text-[#b7c3df] max-w-2xl mx-auto">
              Keep your assistant aligned with your latest listings and tone of voice. Add new project details so replies stay accurate and useful for buyers.
            </p>
            <div className="mt-8">
