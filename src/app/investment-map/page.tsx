      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-4xl px-6 py-20 lg:py-40 text-center">
            ...
            <p className="mt-6 text-base md:text-lg text-[#b7c3df] max-w-2xl mx-auto">
              Visualize the real estate market with our interactive investment map. Explore properties, analyze trends, and identify investment hotspots.
            </p>
            <div className="mt-8">
                <Link href="/discover">
...
export default InvestmentMapPage;
