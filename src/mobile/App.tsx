...
import GoogleAdCampaignFunnel from './GoogleAdCampaignFunnel';
...
import ListingBuilderFunnel from './ListingBuilderFunnel';
  ...
  const renderScreen = () => {
    switch (currentScreen) {
      case 'dashboard':
        return (
          <MyProjectsScreen
            onCreateNew={() => navigateTo('listingBuilderFunnel')}
      ...
      case 'templateLibrary':
        return (
          <TemplateLibraryScreen
            onBack={() => navigateTo('listingBuilderFunnel')}
            onSelect={(template) => {
      ...
      case 'createCampaignWizard':
        return (
          <GoogleAdCampaignFunnel
            onBack={() => navigateTo('googleAdsDashboard')}
            onComplete={(data) => {
              console.log('Campaign planned:', data);
              navigateTo('googleAdsDashboard');
            }}
          />
        );

      case 'listingBuilderFunnel':
        return (
          <ListingBuilderFunnel
            onBack={() => navigateTo('dashboard')}
            onComplete={(data) => {
              console.log('Listing draft:', data);
              setServiceType('website');
              navigateTo('templateLibrary');
            }}
          />
        );
