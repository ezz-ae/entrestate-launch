      ...
      <div className="container mx-auto px-4 py-12 sm:py-16">
        <Card className="relative overflow-hidden rounded-3xl liquid-glass p-6 sm:p-10">
          <div className="relative grid items-center gap-8 md:grid-cols-2">
            {/* Left copy */}
            <div>
              <p className="mb-2 text-[11px] tracking-widest text-lime-300">LAUNCH YOUR SITE</p>
              <h3 className="text-2xl font-bold leading-tight text-white sm:text-3xl">
                Buy a template, get a live subdomain, customize with AI
              </h3>
              <p className="mt-2 max-w-prose text-sm text-neutral-400">
                Pick a ready template, pay once, and open the AI builder to customize instantly.
              </p>
            </div>
              ...
              <div className="relative rounded-[28px] liquid-glass p-2 shadow-2xl">
                <div className="relative aspect-[9/19] w-full overflow-hidden rounded-2xl bg-black">
                  ...
                  <LazyVideo
                    ...
                    muted={true}
                    playsInline={true}
                    aria-label="Mashroi preview - AI builder on mobile"
                  />
                  {/* On-screen content */}
                  <div className="relative p-3">
                    <div className="mx-auto mb-3 h-1.5 w-16 rounded-full bg-white/20" />
                    <div className="space-y-1 px-1">
                      <div className="text-5xl font-extrabold text-lime-300">Launch in Minutes</div>
                      <p className="text-xs text-white/80">Templates + AI builder + instant subdomain</p>
          ...
          <div className="grid gap-8 md:grid-cols-[1.2fr_1fr_1fr]">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-xl font-semibold text-white">Mashroi</span>
              </div>
                ...
                <ul className="space-y-2 text-sm text-neutral-300">
                  <li className="flex items-center gap-2">
                    ...
                    <a
                      ...
                      aria-label="Follow Mashroi on Twitter"
                    >
                      X/Twitter
                    </a>
                  </li>
